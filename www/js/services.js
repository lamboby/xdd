...
.factory('News', function () {
    var news = [{
        id: 0,
        title: '欢迎来到小叮当',
        time: '一款为家长提供贴心报平安的手机应用',
        content: '我们致力于构建更平安的园区，用真诚让家长们多一份安心'
    }, {
        id: 1,
        title: '新版本',
        time: '2015-06-03 01:33:19',
        content: '小叮当V1.1版本发布'
    }];
    if (itru_isTest()) news = [{
        id: 0,
...
.factory("Utils", function ($http, $state, $ionicPopup, $ionicLoading, $location) {
    ...
    var _execWithoutToken = function (url, params,callback,code0_callback, notShowLoading) {
